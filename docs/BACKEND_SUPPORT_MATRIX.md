...
| Panic-freedom at the seam | n/a | n/a | **NO at `--cq-level 0`** — see the quality-dial row. Seam obligation 2 (zenavif CLAUDE.md) is not met for that cell |

...
#   prange464  ZENRAVIF_SD2_PRANGE=4,64         (kill the (4,16)/(4,32) caps)
#   prange432  ZENRAVIF_SD2_PRANGE=4,32
...
#   combo      prange464 + rdotx + cdef + lrf   (aom-parity coding-tools shape)
#
...
export QGRID_ZR
ARMS="${ARMS:-base prange464 prange432 rdotx cdef lrf segoff yuv420 combo}"
...
for arm in $ARMS; do
  unset ZENRAVIF_TUNE ZENRAVIF_SD2_PRANGE ZENRAVIF_SD2_RDOTX ZENRAVIF_SD2_CDEF \
        ZENRAVIF_SD2_LRF ZENRAVIF_SD2_SEG CAVIF_EXTRA 2>/dev/null || true
  case "$arm" in
    base) : ;;
    prange464) export ZENRAVIF_SD2_PRANGE=4,64 ;;
    ...
    combo) export ZENRAVIF_SD2_PRANGE=4,64 ZENRAVIF_SD2_RDOTX=1 \

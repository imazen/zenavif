...
| `encode-svt-rs` | EXPERIMENTAL encoding via svtav1-rs (pure Rust SVT-AV1 port; 8-bit 4:2:0 stills; dims multiples of 64 at any speed, arbitrary at speed ≥ 5, multiples of 8 at speed ≥ 6 with alpha/gray; git dep) |

...
# Exact film-grain decode parity; caller supplies the corpus fixture explicitly.
arm-filmgrain-parity fixture iters="3":
    cargo run -p zenavif --example heaptrack_decode -- {{fixture}} {{iters}} --verify-threads

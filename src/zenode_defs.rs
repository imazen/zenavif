//! zenode node definitions for AVIF encoding.
//!
...
#[node(id = "zenavif.encode", group = Encode, phase = Encode)]
...
/// Register all AVIF zenode definitions with a registry.
pub fn register(registry: &mut NodeRegistry) {
    registry.register(&ENCODE_AVIF_NODE);
}

/// All AVIF zenode definitions.
...
mod tests {
    ...
    fn from_kv_quality() {
        ...
        assert_eq!(node.get_param("quality"), Some(ParamValue::I32(90)));
    ...
    fn json_round_trip() {
        ...
        params.insert("quality".into(), ParamValue::I32(92));
        ...
        assert_eq!(node.get_param("quality"), Some(ParamValue::I32(92)));
        ...
        assert_eq!(node2.get_param("quality"), Some(ParamValue::I32(92)));
